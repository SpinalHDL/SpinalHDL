...
object AccessType {
  ...
  case object W1CHS extends AccessType  // SoftWare Write 1 Clear then HarddWare Set, SW high priority than HW
  case object W1SHS extends AccessType  // SoftWare Write 1 Set   then HarddWare Set, SW high priority than HW
