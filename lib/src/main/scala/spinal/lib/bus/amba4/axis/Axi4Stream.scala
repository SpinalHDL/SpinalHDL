...
object Axi4Stream {
  ...
  implicit class Axi4StreamRich(stream: Stream[Axi4StreamBundle]) {
    ...
    def toFragmentStream[T <: Data](newType: HardType[T], alignment: BitAlignment = LSB): Stream[Fragment[T]] = {
