...
import spinal.lib.memory.sdram.xdr.Dfi.Interface.{CoreParameterAggregate, IDFI, TaskPort}
import spinal.lib.memory.sdram.xdr.Dfi.Tools.{CmdTxd, RdDataRxd, WrDataTxd}
