...
//import spinal.lib._
//import spinal.lib.memory.sdram.Dfi.Alignment.{CAAlignment, CtrlAlignment, RdAlignment, WrAlignment}
//import spinal.lib.memory.sdram.Dfi.Interface.{CoreParameterAggregate, CorePort, CorePortParameter, Dfi}
