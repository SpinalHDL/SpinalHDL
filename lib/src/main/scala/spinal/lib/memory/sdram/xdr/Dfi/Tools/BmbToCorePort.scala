...
import spinal.lib.memory.sdram.xdr.Dfi.CtrlWithBmb.BmbPortParameter
import spinal.lib.memory.sdram.xdr.Dfi.Interface.{CoreParameterAggregate, CorePort, CorePortParameter}
