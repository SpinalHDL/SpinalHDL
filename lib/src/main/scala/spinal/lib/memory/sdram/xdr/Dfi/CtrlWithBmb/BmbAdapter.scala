...
import spinal.lib.memory.sdram.xdr.Dfi.Interface.{CoreCmd, CoreParameterAggregate, CorePort, CorePortParameter, PhyLayout}
import spinal.lib.memory.sdram.xdr.Dfi.Tools.BmbToCorePort
