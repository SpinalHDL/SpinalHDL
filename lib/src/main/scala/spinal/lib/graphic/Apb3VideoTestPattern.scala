...
// Date: 2026/06
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// File: Apb3VideoTestPattern.scala
...
case class Apb3VideoTestPattern(
    vtpp: VideoPatternParameter,
    vtcp: VideoTimingParameter
) extends Component {

  val io = new Bundle {
    val apb = slave(Apb3(Apb3VideoTestPattern.getApb3Config))
...
object GenerateApb3VideoTestPattern {
  def main(args: Array[String]): Unit = {

    val report = SpinalVerilog(
      new Apb3VideoTestPattern(
