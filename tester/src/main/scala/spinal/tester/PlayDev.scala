...
object PlayMakeable extends App{
  ...
  val form1 = SymbiFlow.formal(test,workDir="pesto")
    .log()
    .solver(Solver.z3)
    .pass()
    ...
    .append(100)
  val form2 = SymbiFlow.formal(test,workDir="pesto").solver(Solver.z3).pass().dumpVCD("pesto/test.vcd").outputFolder("pesto/test2").append(100).log()
  val form3 = SymbiFlow.formal(test,workDir="pesto").solver(Solver.z3).pass().dumpVCD("pesto/test.vcd").outputFolder("pesto/test3/1/2/3/").append(100).log()
  val form4 = SymbiFlow.formal(test,workDir="pesto").solver(Solver.z3).pass().dumpVCD("pesto/test.vcd").outputFolder("pesto/test4").append(100).log()
